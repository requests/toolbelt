...
class ChunkedMultipartEncoder(MultipartEncoder):
    """Allows for file-like objects without a length, e.g., stdin."""

    def __init__(self, *args, **kwargs):
        super(ChunkedMultipartEncoder, self).__init__(self, *args, **kwargs)
        del self.__len__
